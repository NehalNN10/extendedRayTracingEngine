...
void World::build(void) {
    ...
    // neon side lights - red and blue
    add_light(new PointLight(Point3D(-1500, 400, -200), RGBColor(1.0, 0.1, 0.1), 1.0, 0.0, 0.0));
    ...
    std::cout << "Loading 32 bunnies and building chessboard...\n";
    ...
    for (int x = 0; x < 8; x++) {
        for (int z = 0; z < 8; z++) {
            ...
            // chessboard spawning - no bunnies in the middle
            if (z < 2 || z >= 6) {
