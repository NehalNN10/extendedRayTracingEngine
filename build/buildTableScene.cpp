...
void World::build(void) {
    ...
    auto* dragon_material = new Phong(0.22f, 0.62f, 0.20f, 24.0f, RGBColor(0.16, 0.60, 0.22));
    auto* teapot_material = new Phong(0.20f, 0.60f, 0.35f, 40.0f, RGBColor(0.80, 0.48, 0.18));
    auto* bunny_material = new Phong(0.25f, 0.55f, 0.25f, 18.0f, RGBColor(0.88, 0.86, 0.82));
    ...
    PLYReader::load_ply("models/utah_teapot.ply", this, teapot_material, 72.0f, Vector3D(320, -118, -10), 180.0);
